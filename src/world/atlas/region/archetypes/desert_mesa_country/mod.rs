...
pub const DEF: RegionArchetypeDef = RegionArchetypeDef {
    id: RegionArchetype::DesertMesaCountry,
    biome_family: BiomeFamily::Desert,
    terrain_form_family: TerrainFormFamily::MesaCountry,
    summary: "Dry stepped upland with mesa and rim logic.",
    regional_traits: &[
    ...
    allowed_meso_keys: &["escarpment_band", "ravine", "crater",],
