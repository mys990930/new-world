...
pub const DEF: RegionArchetypeDef = RegionArchetypeDef {
    id: RegionArchetype::TemperateBroadValley,
    biome_family: BiomeFamily::TemperateGrassland,
    terrain_form_family: TerrainFormFamily::BroadValley,
    summary: "Open temperate valley floor with lateral slopes.",
    regional_traits: &[
    ...
    allowed_meso_keys: &["ravine", "hill_cluster",],
