...
- Hill support blending should stay continuous across neighboring columns; candidate contribution should fade smoothly by distance instead of toggling from hard top-N source switches.
