...
- Current launch tuning should also keep cluster merge conservative enough that nearby strong sources do not immediately collapse into one oversized bright mass across a whole preview edge.
...
- Broad shoulder and envelope support should help hills merge and ease back into plains, but should not by themselves saturate to the same near-peak uplift as the summit core in top-down preview.
