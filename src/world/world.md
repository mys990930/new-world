...
- Chunk generation now consumes atlas fields inside `world::generation`, resolves terrain profiles, and realizes a stone-only first-pass relief model around fixed sea level `y = 0`.
