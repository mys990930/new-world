...
pub enum GraphGenerationStage {
    PaddedVoronoiGraph,
    BaseGraphFields,
    MacroOwnershipElevationResolve,
    RidgeFaultGuideSelection,
    CoastEdgeGuideSelection,
    HydrologySolve,
    RiverPlanRealization,
    FinalCellContextResolve,
    NoisyBoundaryRealization,
    MacroFieldRasterization,
    ChunkPixelize,
    HeightfieldVoxelColumnRealization,
    SurfacePlan,
    VegetationPlan,
    VoxelFill,
}

pub const GRAPH_GENERATION_STAGES: [GraphGenerationStage; 15] = [
    GraphGenerationStage::PaddedVoronoiGraph,
    GraphGenerationStage::BaseGraphFields,
    GraphGenerationStage::MacroOwnershipElevationResolve,
    GraphGenerationStage::RidgeFaultGuideSelection,
    GraphGenerationStage::CoastEdgeGuideSelection,
    GraphGenerationStage::HydrologySolve,
    GraphGenerationStage::RiverPlanRealization,
    GraphGenerationStage::FinalCellContextResolve,
    GraphGenerationStage::NoisyBoundaryRealization,
    GraphGenerationStage::MacroFieldRasterization,
    GraphGenerationStage::ChunkPixelize,
    GraphGenerationStage::HeightfieldVoxelColumnRealization,
...
mod tests {
    ...
    #[test]
    fn pipeline_stage_order_keeps_chunk_pixelize_between_macro_field_and_heightfield() {
        assert_eq!(
            graph_generation_stages(),
            &[
                GraphGenerationStage::PaddedVoronoiGraph,
