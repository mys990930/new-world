...
pub const DEFAULT_TRIBUTARY_SOURCE_THRESHOLD: f32 = 0.32;
pub const DEFAULT_TRIBUTARY_SOURCE_HYDRATION: f32 = 0.46;
pub const DEFAULT_TRIBUTARY_MAX_PATH_EDGES: u32 = 18;
pub const DEFAULT_TRIBUTARY_SOURCE_MIN_SPACING_BLOCKS: f32 = 384.0;
pub const DEFAULT_TRIBUTARY_PARALLEL_PATH_MIN_SPACING_BLOCKS: f32 = 384.0;
