...
const LAKE_INLET_RIVER_THRESHOLD_CAP: f32 = 22.0;
...
fn is_headwater_near_local_peak(
    index: usize,
    elevations: &[f32],
    terminals: &[bool],
    lake_candidates: &[bool],
...
fn prune_multi_incoming_selected_branches(
    selected: &mut [bool],
    downstream: &[Option<usize>],
    flow: &[f32],
) -> usize {
