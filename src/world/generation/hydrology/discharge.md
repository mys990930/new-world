...
3. lake inlet/outlet은 valid river-system transition이며 Q ledger reset 지점이 아니다.
4. lake-local cap은 inlet/outlet shape를 제한할 수 있지만 canonical river-system Q를 덮어쓰면 안 된다.
5. river_plan은 `GraphRiverSegment.flow_accumulation`을 canonical Q로 소비한다.
