...
- note:
  ...
  - hill clusters now use atlas-owned clustered guide envelopes plus feature-owned asymmetric macro-lobe-chain resolution in the chunk pass, so several chunk-scale hills survive into the preview with taller relief and less circular read
