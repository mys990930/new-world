...
- note:
  ...
  - hill clusters are the first launch feature being moved toward that model, using atlas-owned clustered guide envelopes plus feature-owned asymmetric macro-lobe-chain resolution in the chunk pass with broader shoulders, dominant-source pruning, and a blended target surface
