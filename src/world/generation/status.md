...
- note:
  ...
  - hill clusters are the first launch feature being moved toward that model, using atlas-owned clustered guide envelopes plus feature-owned asymmetric macro-lobe-chain resolution in the chunk pass with broader shoulders, dominant-source pruning, a wider neighboring-guide scan, source-stable fallback orientation, and a blended target surface
