...
- note:
  ...
  - hill clusters now use atlas-owned clustered guide envelopes plus feature-owned macro-lobe resolution in the chunk pass, so several chunk-scale hills survive into the preview instead of collapsing into tiny hilllets or one broad smear
