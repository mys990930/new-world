...
- A later meso layer should shape the broad local relief that this pass receives, but `realize` should still consume meso-derived basin or terrace hints rather than owning meso generation itself.
