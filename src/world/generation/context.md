...
- The current stone phase only needs a `stone` palette entry, but the type is kept as a module boundary so later material passes can expand without reworking every call site.
