...
mod tests {
    ...
    use crate::world::generation::{
        ...
        build_chunk_realization_field_patch, prepare_chunk_generation_inputs,
    };
    ...
    #[test]
    #[ignore = "slow current generation meso pipeline smoke test"]
    ...
    #[test]
    #[ignore = "slow current generation meso search smoke test"]
    ...
    #[test]
    #[ignore = "slow current generation meso seam regression test"]
    ...
    #[test]
    #[ignore = "slow current generation meso context-boundary regression test"]
    ...
    #[test]
    #[ignore = "slow current generation meso reported seam regression test"]
    ...
    #[test]
    #[ignore = "slow current generation meso preview-window regression test"]
