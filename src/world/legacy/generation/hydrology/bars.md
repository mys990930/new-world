...
- consumes a reach-style bar-strength scale so meanders, widenings, confluences, and lower slow reaches can expose stronger bars while straight or shallow source reaches keep them subtle
...
6. straight or shallow source reaches should not grow the same strong gravel bands as active meanders unless confluence/widening context independently supports them
