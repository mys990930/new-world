...
- build placement previews use the selected block's top/bottom/side texture layers and material mapping, with bridge-owned alpha tint strong enough to preserve the selected block's texture color
