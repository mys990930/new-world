...
- The current prototype uses an explicit 2:1 dimetric quarter-view basis plus orthographic projection so the renderer can receive a stable render-only camera pose
