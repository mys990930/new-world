...
impl GameApp {
    ...
    pub fn render(&mut self) {
        ...
        if let Err(error) = self.renderer.render(RenderFrameInput {
            ...
            occlusion_focus: render_frame.occlusion_focus,
            occlusion_inner_radius: render_frame.occlusion_inner_radius,
            occlusion_outer_radius: render_frame.occlusion_outer_radius,
