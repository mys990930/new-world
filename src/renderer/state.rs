...
pub(crate) struct RendererBackend {
    ...
    pub(crate) environment_cutout_bind_group: wgpu::BindGroup,
    pub(crate) environment_fade_bind_group: wgpu::BindGroup,
    pub(crate) occlusion_cutout_buffer: wgpu::Buffer,
    pub(crate) occlusion_fade_buffer: wgpu::Buffer,
