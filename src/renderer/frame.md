...
- Terrain shading now includes a subtle top-face contour treatment so receding height changes do not flatten into a single plane as easily in quarter view.
